                ...
                <Form {...form}>
                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    <FormLabel className="text-transparent bg-gradient-to-r from-pink-600 to-purple-600 bg-clip-text font-medium">Username</FormLabel>
                                    <FormControl>
                                        <Input 
                                            placeholder="Enter your username" 
                                            {...field} 
                                            disabled={isLoading}
                                            className="bg-white border-2 border-gradient-to-r from-pink-300 to-purple-300 focus:border-gradient-to-r focus:from-pink-500 focus:to-purple-500 focus:ring-2 focus:ring-pink-200 text-gray-900 placeholder-gray-500 shadow-sm"
                                        />
                                    </FormControl>
                                    <FormDescription className="text-transparent bg-gradient-to-r from-pink-500 to-purple-500 bg-clip-text">
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    <FormLabel className="text-transparent bg-gradient-to-r from-pink-600 to-purple-600 bg-clip-text font-medium">Password</FormLabel>
                                    <FormControl>
                                        <Input 
                                            type="password" 
